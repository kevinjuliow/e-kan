    ...
    <div className="w-full flex items-center justify-center mt-24">
      ...
      <div className="max-w-screen-xl w-full h-full p-8 xl:px-0 flex flex-col items-center justify-center">
        <div className="relative w-full md:w-[50%] flex items-center justify-center text-white border-none">
          ...
          <input className="w-full px-4 py-4 ps-12 text-base rounded-lg bg-darkaqua focus:outline-none" placeholder="Cari ikan di sini..." onChange={handleSearchChange} required />
        ...
        <ShowItem searchQuery={searchQuery} />
      </div>
    </div>
  )
}
